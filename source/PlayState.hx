...
class PlayState extends MusicBeatState
{
	...
	public static var imaginaryBPM:Int = 60;
	...
	function shit()
	{
		new FlxTimer().start((imaginaryBPM / 4) / 1000, function(tmr:FlxTimer)
		{
			shit();
		});
	}

	function doTheFunnyBeat()
	{
		beatHitLol.loadGraphic(Paths.image("on"));
		new FlxTimer().start(0.3, function(tmr:FlxTimer){
			beatHitLol.loadGraphic(Paths.image("off"));
		});
	}
	...
	override public function create()
	{
		...
		beatHitLol = new FlxSprite(FlxG.width / 2 /* middle */,  FlxG.height - 256, Paths.image("off"));
		// add(beatHitLol);
		// shit();
